            ...
            <div className="flex flex-col md:flex-row items-start md:items-center gap-8 mb-10">
              ...
              <div className="relative group">
                ...
                <div className="relative w-40 h-40 rounded-full overflow-hidden border-4 border-transparent bg-gradient-to-br from-gray-700 via-gray-800 to-gray-900 p-1">
                  ...
                  {/* Photo - ЗДЕСЬ ПРОСТО ИЗМЕНИ НАЗВАНИЕ ФОТО */}
            ...
            <div>
              ...
              <div className="space-y-6">
                <p className="text-gray-400 leading-relaxed">
                  Information Systems In Management student passionate about building scalable and efficient web applications. 
                  Currently focusing on mastering full-stack development with modern JavaScript ecosystem.
                </p>
        ...
        <section className="mb-32">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {[
              ...
              <div 
                key={index}
                className="bg-gradient-to-br from-gray-800/50 to-gray-900/50 border border-gray-700/50 rounded-xl p-6 backdrop-blur-sm hover:border-cyan-500/30 transition-all duration-300 group"
              >
                ...
                {project.link && (
                  <a 
                    ...
                    className="text-sm text-cyan-400 hover:text-cyan-300 inline-flex items-center"
                  >
                    VIEW REVIEW
                  </a>
                )}
          ...
          <div className="bg-gradient-to-br from-gray-800/30 to-gray-900/30 border border-gray-700/50 rounded-2xl p-8 backdrop-blur-sm">
            <div className="text-center max-w-2xl mx-auto">
              ...
              <p className="text-gray-400 mb-10 leading-relaxed">
                I'm currently seeking internship positions where I can contribute to meaningful projects 
                while expanding my skills in modern web development.
              </p>
              
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <a 
                  href="mail:slatergt228@gmail.com" 
                  className="px-8 py-4 bg-gradient-to-r from-cyan-600 to-blue-600 text-white font-medium rounded-lg hover:from-cyan-700 hover:to-blue-700 transition-all duration-300 shadow-lg hover:shadow-cyan-500/20"
                >
                  SEND EMAIL
                </a>
                
                <a 
                  href="https://github.com/tamerlan1wow" 
                  target="_blank"
                  rel="noopener noreferrer"
                  className="px-8 py-4 border border-gray-700 text-gray-300 font-medium rounded-lg hover:border-cyan-500 hover:text-cyan-400 transition-all duration-300"
                >
                  GITHUB PROFILE
                </a>
              </div>
